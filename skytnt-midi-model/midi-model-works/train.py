...
## MYK edit: do not check alignment
    train_dataset = MidiDataset(train_midi_list, tokenizer, check_alignment=False, max_len=opt.max_len)
    val_dataset = MidiDataset(val_midi_list, tokenizer, check_alignment=False, max_len=opt.max_len, aug=False)
